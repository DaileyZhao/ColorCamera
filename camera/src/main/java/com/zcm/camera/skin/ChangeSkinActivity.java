...
import com.zcm.ui.changeskin.callback.ISkinChangingCallback;
import com.zcm.ui.changeskin.utils.L;
    ...
    private void initEvents() {
        ...
        mListView.setAdapter(new ArrayAdapter<String>(this, -1, mDatas) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    convertView = LayoutInflater.from(mThisActivity).inflate(R.layout.item, parent
                            , false);
                }
            ...
            case R.id.id_action_plugin_skinchange:
                SkinManager.getInstance().changeSkin(mSkinPkgPath, "com.zhy.plugin", new ISkinChangingCallback() {
                    ...
                    public void onError(Exception e) {
                        Toast.makeText(mThisActivity, "换肤失败", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onComplete() {
                        Toast.makeText(mThisActivity, "换肤成功", Toast.LENGTH_SHORT).show();
                    }
                });
                break;
